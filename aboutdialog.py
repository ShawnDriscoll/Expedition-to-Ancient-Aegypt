...
class Ui_aboutDialog(object):
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.textLabel.setText(_translate("aboutDialog", "<html><head/><body><p><span style=\" font-weight:600;\">ETAA CharGen for Windows 11</span></p><p>Version: Total Party Skills Edition</p><p>Build: 0.2.0 (Beta)</p><p>Produced by Shawn Driscoll. Copyright (C) 2024.</p><p>Buy the game at <a href=\"https://www.drivethrurpg.com/product/371713/Expedition-to-Ancient-Aegypt\"><span style=\" text-decoration: underline; color:#0000ff;\">DriveThruRPG</span></a><br/><br/>Visit blog at <a href=\"http://shawndriscoll.blogspot.com\"><span style=\" text-decoration: underline; color:#0000ff;\">shawndriscoll.blogspot.com</span></a><br/>For support, email <a href=\"mailto:shawndriscoll@hotmail.com?subject=ETAA CharGen 0.2.0b\"><span style=\" text-decoration: underline; color:#0000ff;\">shawndriscoll@hotmail.com</span></a></p><p>Qt GUI Toolkit is copyright (C) 2020 The Qt Company Ltd</p><p><br/></p><p>The Expedition to Ancient Aegypt! RPG was written by R. Joshua Holland. Copyright 2021 - 2022, Total Party Skills.</p></body></html>"))
