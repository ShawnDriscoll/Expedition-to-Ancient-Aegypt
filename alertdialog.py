...
class Ui_alertDialog(object):
    ...
    def retranslateUi(self, alertDialog):
        ...
        self.textLabel.setText(_translate("alertDialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:10pt; font-weight:600;\">Build 0.2.0 (Beta) of ETAA CharGen has</span></p><p align=\"center\"><span style=\" font-size:10pt; font-weight:600; color:#ff0000;\">EXPIRED</span><span style=\" font-size:10pt; font-weight:600;\">.</span></p><p align=\"center\"><span style=\" font-size:10pt;\">Check for a newer release from </span><a href=\"https://github.com/ShawnDriscoll/Expedition-to-Ancient-Aegypt-RPG-CharGen\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">GitHub</span></a><span style=\" font-size:10pt;\">.</span><br/><span style=\" font-size:10pt;\">For support, email </span><a href=\"mailto:shawndriscoll@hotmail.com?subject=ETAA CharGen 0.2.0 [EXPIRED Beta]\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">shawndriscoll@hotmail.com</span></a></p><p align=\"center\"><span style=\" font-size:10pt;\">Thank you for participating.</span></p></body></html>"))
