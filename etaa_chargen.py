...
__app__ = 'ETAA CharGen 0.0.1 (Beta)'
__version__ = '0.0.1b'
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.rank_choice = ['Choose', 'American', 'British', 'Egyptian', 'French', 'German', 'Ottoman']
        self.rank_language = ['', 'English', 'English', 'Arabic', 'French', 'Deutch', 'Turkish']
    ...
    def printButton_clicked(self):
        ...
        pdf.cell(txt='Flag: ' + self.rank_chosen + '        Language: ' + self.languageDisplay.text(), ln=1)
        pdf.cell(txt='Job: ' + self.dept_chosen, ln=1)
...
if __name__ == '__main__':
    ...
    log = logging.getLogger('ETAA_Chargen_' + __version__)
